...
public class TestLaunch {
    ...
    public void run() {
        ioService.outputString("\n" + localeService.getMessage("to.start.testing"));
        String firstName = ioService.readString(localeService.getMessage("enter.name"));
        String lastName = ioService.readString(localeService.getMessage("enter.last.name"));
