...
### Тема: Менеджер MP3 коллекций (MP3 Collection Manager)
...
* [Spring Integration](https://docs.spring.io/spring-boot/docs/2.7.8/reference/htmlsingle/#messaging.spring-integration)
